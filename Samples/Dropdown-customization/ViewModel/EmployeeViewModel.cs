...
namespace Dropdown_customization
{
    ...
    public class EmployeeViewModel
    {
        ...
        public EmployeeViewModel()
        {
            ...
            Employees.Add(new Employee() { Name = "Sebastian", Email = "Sebastian@syncfusion.com" });
            Employees.Add(new Employee() { Name = "Gabriella", Email = "Gabriella@syncfusion.com" });
            Employees.Add(new Employee() { Name = "Alexander", Email = "Alexander@syncfusion.com" });          
        }
    }
}
